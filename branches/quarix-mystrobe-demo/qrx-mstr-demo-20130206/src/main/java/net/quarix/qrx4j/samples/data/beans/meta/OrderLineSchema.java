...
public class OrderLineSchema extends DAOSchema<OrderLine> {
	...
	private void asignValues() {
		...
		rowidProp.put(SchemaColumnProperties.Format, "x(8)");
		rowidProp.put(SchemaColumnProperties.Type, "character");
		rowidProp.put(SchemaColumnProperties.DefaultValue, "");
		rowidProp.put(SchemaColumnProperties.Required, "false");
		rowidProp.put(SchemaColumnProperties.Sortable, "false");
		rowidProp.put(SchemaColumnProperties.Label, "SalesRepName");
		rowidProp.put(SchemaColumnProperties.Tooltip, "");
		rowidProp.put(SchemaColumnProperties.ViewAs, "fill-in");
		...
		rowstateProp.put(SchemaColumnProperties.Format, "x(8)");
		rowstateProp.put(SchemaColumnProperties.Type, "integer");
		rowstateProp.put(SchemaColumnProperties.DefaultValue, "0");
		rowstateProp.put(SchemaColumnProperties.Required, "false");
		rowstateProp.put(SchemaColumnProperties.Sortable, "false");
		rowstateProp.put(SchemaColumnProperties.Label, "SalesRepName");
		rowstateProp.put(SchemaColumnProperties.Tooltip, "");
		rowstateProp.put(SchemaColumnProperties.ViewAs, "fill-in");
